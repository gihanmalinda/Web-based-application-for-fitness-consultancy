...
<?php 
  ...
  $clients = mysqli_query($connection, $query);
    ...
    while ($client = mysqli_fetch_assoc($clients)) {
      ...
      $client_list .= "<td><a href=client_delete.php?nic={$client['nic']}>Inactive</a></td>";
      $client_list .= "</tr>";
    }
 ?>
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                            <li class="w-100">
                                <a href="" class="nav-link px-0"> <span class="d-none d-sm-inline">Active Clients</span></a>
                            </li>
                            <li>
...
<div class="table-responsive px-4">
  ...
  <h5 class="display-6 text-center">Active Client List</h5>
