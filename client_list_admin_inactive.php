                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                            ...
                            <li>
                                <a href="" class="nav-link px-0"> <span class="d-none d-sm-inline">Inactive Clients</span></a>
                            </li>
                        </ul>
                    </li>
...
<?php 
  ...
  $query = "SELECT nic,name,gender,dob,email,address,mobile_no,attendance FROM client WHERE deletion_indicator = 'x' ORDER BY name";
  $inactive_clients = mysqli_query($connection, $query);
    ...
    while ($inactive_client = mysqli_fetch_assoc($inactive_clients)) {
      ...
      $inactive_client_list .= "<td>{$inactive_client['attendance']}</td>";


      $inactive_client_list .= "<td><a href=client_active.php?nic={$inactive_client['nic']}>Active</a></td>";
      $inactive_client_list .= "</tr>";
    }
 ?>
