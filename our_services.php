...
<h1 class="display-6 text-center">Our Services</h1>
<div class="mt-4 col-md-12"></div> <!-- Margin between divs -->
...
$records = mysqli_query($db,"select image from article WHERE post_type = 'Advertisement';"); // fetch data from database
