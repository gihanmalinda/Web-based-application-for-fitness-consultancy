...
<div class="alert alert-danger d-flex justify-content-center align-items-center container " role="alert">
  Please contact to reset your password. Hasala - 94 77 24 19 108

</div>

  <div class="mt-4 col-md-12"></div> <!-- Margin between divs -->

<div class="alert alert-info d-flex justify-content-center align-items-center container " role="alert">
  <a class="btn btn-dark" href="home.php" role="button">Back to Home</a>
</div>
